...
public class IgnorePlayerLoader extends HLoader {
    ...
    public void load() {
        ...
        try {
            ...
            logger.info(HARMONY_CHAT_PREFIX + " IgnorePlayerMap has been deserialized.");
        } catch (IOException ex) {
            this.holder = new IgnorePlayerHolder();
            logger.info(HARMONY_CHAT_PREFIX + " could not load IgnorePlayerMap");
    ...
    public void save() {
        ...
        try {
            ...
            out.close();
            file.close();
            logger.info(HARMONY_CHAT_PREFIX + " IgnorePlayerMap has been serialized.");
